...
# logging
logfile_dir = 'logs/run_strat_live_paper_logs/' + time.strftime("%Y%m%d-%H%M%S")
...
def main():
	...
	ts.test_strat1(net_tracker_fname=net_limit_tracker_fname, paper_trading=True, plot_post_run=True)
